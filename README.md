...
> - **Do not** enter your infomation such as email and password into 2 workflow file ( `daily.yml` and `manual.yml` ) cause it will not work and may leak your infomation to everyone
